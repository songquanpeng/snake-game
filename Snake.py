...
class Snake:
    ...
    def go(self, direction):
        ...
        # print("current head position: x: {0[0]}, y: {0[1]} snake' direction: {1}".format(self.head, self.direction))
        # print("current head position board value:{}".format(self.board[self.head[0]][self.head[1]]))
        # collision = False
        # if self.direction == UP:
        #     if self.head[1] == 0:
        #         collision = True
        ...
        #     new_head[0] += 1
        # new_head = self.head[:]
        # collision, update = self.check_collision()
        # new_head[update[0]] += update[1]
...
class Game(QMainWindow):
    def __init__(self):
        ...
        self.brush = [QBrush(Qt.white, Qt.SolidPattern), QBrush(Qt.darkBlue, Qt.SolidPattern),
                      QBrush(Qt.green, Qt.SolidPattern), QBrush(Qt.yellow, Qt.SolidPattern)]
        self.time_count = 0
        # snake
        self.snake = Snake()
